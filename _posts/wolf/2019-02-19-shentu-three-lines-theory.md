...
我们先分析一下，`4` 个狼人分发到位置 `1` 到 `12` 中的所有可能总数，我们根据排列组合的知识知道，这个值是 $$C_{12}^4$$ ，即总的可能情况数为：
...
我们把以上三种类型的可能情况的总数合计一下，得到：

$$15 + 240 + 240 = 495$$，这和前面我们得到 `4` 个狼人分发 `12` 个位置的所有可能总数 $$C_{12}^4 = 495$$ 是相等的，说明所有的情况我们都考虑到了，结果是正确的。
